...
const CreatedTeamsAdmin = () => {
  return (
    ...
    <div className="flex h-screen">
        ...
        <div className="w-2/4  ">
            ...
            <div className="">
                ...
                <label className="flex justify-center my-3"> Team-01 score is : team-01 </label>
                <label className="flex justify-center "> Team-02 score is : team-02</label>
            </div>
    ...
    <div className="flex flex-col items-center my-28 h-screen">
      <div className="mb-6">
        <h1 className="text-2xl font-serif font-bold">Team 1 vs Team 2</h1>
      </div>
